...
module.exports = {
    ...
    plugins: [
        ...
        new ModuleFederationPlugin({
            name: "DashboardApp",  // This application named 'DashboardApp'
            // This is where we define the federated modules that we want to consume in this app. 
            // Note that we specify "Login" as the internal name 
            // so that we can load the components using import("Login/"). 
            // We also define the location where the remote's module definition is hosted: 
            // Login@[http://localhost:3001/remoteEntry.js]. 
